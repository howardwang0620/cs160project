...
public class QuestionAdapter extends ArrayAdapter<Question> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.questionCategory = (TextView) convertView.findViewById(R.id.questionCategoryTextView);
            viewHolder.questionType = (TextView) convertView.findViewById(R.id.questionTypeTextView);
            viewHolder.questionBody = (TextView) convertView.findViewById(R.id.questionBodyTextView);
            viewHolder.averageRating = (TextView) convertView.findViewById(R.id.averageRatingTextView);
        ...
        viewHolder.questionCategory.setText(question.getQuestionCategory());
        viewHolder.questionType.setText(question.getQuestionType());
        ...
        if (question.getQuestionType().equals("Polling")) {
            viewHolder.expirationDate.setVisibility(View.GONE);
        } else {
